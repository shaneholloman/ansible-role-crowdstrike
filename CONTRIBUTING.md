...
issue](https://github.com/cisagov/ansible-role-crowdstrike/issues)
...
request](https://github.com/cisagov/ansible-role-crowdstrike/pulls),
...
```console
cd ansible-role-crowdstrike
pyenv virtualenv <python_version_to_use> ansible-role-crowdstrike
pyenv local ansible-role-crowdstrike
